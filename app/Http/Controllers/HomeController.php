...
class HomeController extends Controller
{
    ...
    public function homepage(){
        ...
        $ch=curl_init();
        $url = '192.168.0.2:8080/api/homepage/vehicles';
    ...
    public function userDashboard(){
        ...
        $ch = curl_init();
        $url = '192.168.0.2:8080/api/member/rent/order/view/'.$mID;
        curl_setopt($ch,CURLOPT_URL,$url);
        curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
        $result=curl_exec($ch);
        ...
        // dd($rental);
        curl_close($ch);
        return view('memberDashboard.userDashboard',compact('rental'));
    }
    
    // userAdmin
    public function adminDashboard(){
        $ch = curl_init();
        $url = '192.168.0.2:8080/api/stats';
        curl_setopt($ch,CURLOPT_URL,$url);
        curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
        $result=curl_exec($ch);
    ...
    public function homeSearch(Request $request){
        ...
        $ch = curl_init();
        $url = 'http://192.168.0.2:8080/api/home/search'; //url section
        curl_setopt($ch,CURLOPT_URL,$url);
